...
const TOP_LEVEL_DIALOG2 = 'TOP_LEVEL_DIALOG2';

const WATERFALL_DIALOG = 'WATERFALL_DIALOG';
const TEXT_PROMPT = 'TEXT_PROMPT';
const NUMBER_PROMPT = 'NUMBER_PROMPT';

class TopLevelDialog2 extends ComponentDialog {
    constructor() {
        super(TOP_LEVEL_DIALOG2);
    ...
    async nameStep(stepContext) {
        ...
        const promptOptions = { prompt: 'Please enter your name in Chinese.' };
    ...
    async ageStep(stepContext) {
        ...
        const promptOptions = { prompt: 'Please enter your age + 100.' };
...
module.exports.TopLevelDialog2 = TopLevelDialog2;
module.exports.TOP_LEVEL_DIALOG2 = TOP_LEVEL_DIALOG2;
